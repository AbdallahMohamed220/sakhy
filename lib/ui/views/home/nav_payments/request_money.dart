        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _beneficiary==false?Container():Container(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(
                    ...
                    fullWidthButton("Request", ()=>Navigator.pushNamed(context, route.confirmWithFaceID),),
              ...
              SizedBox(height: 10.h,),
              _notBeneficiary==false?Container():Container(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(
                    ...
                    SizedBox(height: 5.h,),
                    formField(TextInputType.number, false, _numberController, true, Icons.call_outlined, context, "Phone"),
                    SizedBox(height: 10.h,),
                    Text(
                      "Amount",
                      style:
