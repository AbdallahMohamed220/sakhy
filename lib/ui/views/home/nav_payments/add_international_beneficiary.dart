...
class AddlnternationalBeneficiary extends StatefulWidget {
  @override
  _AddlnternationalBeneficiaryState createState() =>
      _AddlnternationalBeneficiaryState();
}

class _AddlnternationalBeneficiaryState
    extends State<AddlnternationalBeneficiary> {
...
//  String _idorPhoneorEmail = "Id or phone number or email";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Add International Beneficiary"),
        centerTitle: true,
        leading: IconButton(
      ...
      body: Form(
        key: _beneficiaryController.addInternatonalBeneficiaryformKey,
        child: Padding(
